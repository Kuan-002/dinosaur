#!/usr/bin/env python3
"""Joint undirected contrastive-pair GRPO training for the 6-class pair dataset."""
...
def main() -> None:
    ...
    meta = {
        ...
        "selection_objective": "class-margin GRPO plus optional object-a/object-b dense increments and object-sharing-aware contrastive rule-pair margin increment",
        ...
        "component_pair_reward": "contrastive true rule-pair margin increment against other full pair rules; shared objects are not component-level negatives",
    }
