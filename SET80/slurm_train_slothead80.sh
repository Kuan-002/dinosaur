...
RUN_NAME="${RUN_NAME:-slothead80_obj16_geo16_res48_$(date +%Y%m%d_%H%M%S)}"
...
"${PYTHON}" SET80/train_slothead80.py \
  --coco_root "${COCO_ROOT}" \
...
echo "SET80 slothead checkpoint: ${OUT_DIR}/slothead_best.pt"
